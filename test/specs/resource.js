...
describe('Resource', function() {
  ...
  describe('constructor', function() {
    ...
    describe('when given a descriptor with an ill formed link', function() {
      it('throws an error', function() {
        ...
        }).to.throw(/Resource received malformed resource link without "href" property/);
      });
    });
  });
  ...
  describe('#connections', function() {
    it('returns a map of the Resources reachable', function() {
      var descriptor = {
        _links: {
          self: {
            href: '/'
      ...
      expect(resource.connections()).to.deep.equal(connections);
    });
  });
